...
def realm():
    ...
    return {
        ...
        "pstr": ("{}", ("canonical_name",)),
        "properties": [
            ("canonical_name", "str", "0.1", "Canonical name for the realm."),
            (
                "grid",
                "science.topic",
                "0.1",
...
def topic():
    ...
    return {
        ...
        "properties": [
            ...
            (
                "properties",
                "science.topic_property",
                "0.N",
                "Set of associated specialized properties.",
            ),
            (
                "property_sets",
                "science.topic_property_set",
                "0.N",
                "Grouped specialized properties.",
            ),
            ("qc_status", "int", "0.1", "Quality control status of topic."),
            (
                "responsible_parties",
