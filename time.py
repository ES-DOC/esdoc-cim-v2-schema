...
def datetime_set():
    ...
    return {
        ...
        "base": None,
        "is_abstract": True,
        "alternatives": ["time.irregular_dateset", "time.regular_timeset"],
        "properties": [("length", "int", "1.1", "Number of times in set.")],
    }
...
def regular_timeset():
    ...
    return {
        ...
        "is_abstract": False,
        "pstr": (
            "{} times from {} at {} intervals",
            ("length", "start_date", "increment"),
        ),
        "properties": [
            (
                "increment",
...
def time_period():
    ...
    return {
        ...
        "properties": [
            ...
            (
                "date_type",
                "time.period_date_types",
                "1.1",
                "Describes how the date is used to define the period.",
            ),
            ("length", "float", "1.1", "Duration of the time period."),
